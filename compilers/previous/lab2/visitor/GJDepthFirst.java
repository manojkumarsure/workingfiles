...
public class GJDepthFirst<R,A> implements GJVisitor<R,A> {
   ...
   public void checkoverloading()
   {
		...
		for(R key: symboltable.keySet())
		{
            try
            {
				classtable x=new classtable();
				x=((classtable)symboltable.get(key));
				if(x.parentclass!=null && symboltable.get((R)x.parentclass.toString())==null)
				{
					System.out.println("Type error");
					System.exit(0);
				}
						...
						for (String retval: (x.meths.toString()).split(";"))
						{
							...
							else
							{
								for (String retval2: ((((classtable)curr).meths).toString()).split(";"))
								{
									...
									if(retval!=retval2 && (retval.split(" ")[1]).split(":")[0].equals((retval2.split(" ")[1]).split(":")[0]))
									{
										System.out.println("Type error");
										System.exit(0);
									}
   ...
   public R visit(ClassDeclaration n, A argu) {
      ...
      if(symboltable.get((R)(((String) oldArgu) + _ret.toString()))!=null)
	  {
		System.out.println("Type error");
		System.exit(0);
	  }
   ...
   public R visit(VarDeclaration n, A argu) {
      ...
      x.setName(varname);
      x.setType(typename);
      if(symboltable.get((R)(((String)argu) + varname.toString()))!=null)
	  {
		System.out.println("Type error");
		System.exit(0);
	  }
   ...
   public R visit(MethodDeclaration n, A argu) {
      ...
      x.setArglist(plist);
      if(symboltable.get((R)(((String)oldArgu) + methname.toString() + "~"))!=null)
	  {
		System.out.println("Type error");
		System.exit(0);
	  }
